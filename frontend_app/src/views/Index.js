          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              ...
              <p className="mt-4 text-lg leading-relaxed text-slate-500">
                Kothar Dashboardboard is Free and Open Source. It does not
                  ...
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-slate-500">
                        Kothar Dashboardboard comes with a huge number of Fully
        ...
        <div className="justify-center text-center flex flex-wrap mt-24">
          <div className="w-full md:w-6/12 px-12 md:px-4">
            ...
            <p className="text-lg leading-relaxed mt-4 mb-4 text-slate-500">
              Kothar Dashboardboard is a completly new product built using our
